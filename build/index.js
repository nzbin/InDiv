...
/***/ "./node_modules/_easier-cookie@1.0.11@easier-cookie/src/index.js":
/*!***********************************************************************!*\
  !*** ./node_modules/_easier-cookie@1.0.11@easier-cookie/src/index.js ***!
  \***********************************************************************/
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar Utils_1 = __webpack_require__(/*! ../Utils */ \"./src/Utils/index.ts\");\nvar CompileUtils_1 = __webpack_require__(/*! ../CompileUtils */ \"./src/CompileUtils/index.ts\");\n// abstract class Lifecycle<Vm = any> implements ILifecycle {\nvar Lifecycle = /** @class */function () {\n    function Lifecycle() {\n        this.compileUtil = new CompileUtils_1.CompileUtil();\n        this.utils = new Utils_1.default();\n        this.$location = {\n            state: this.$getLocationState.bind(this),\n            go: this.$locationGo.bind(this)\n        };\n    }\n    Lifecycle.prototype.$getLocationState = function () {\n        return {\n            path: this.$vm.$esRouteObject.path,\n            query: this.$vm.$esRouteObject.query,\n            params: this.$vm.$esRouteObject.params\n        };\n    };\n    Lifecycle.prototype.$locationGo = function (path, query, params) {\n        if (this.$vm.$esRouteMode === 'state') {\n            var rootPath = this.$vm.$rootPath === '/' ? '' : this.$vm.$rootPath;\n            history.pushState({\n                path: path,\n                query: query,\n                params: params\n            }, null, \"\" + rootPath + path + this.utils.buildQuery(query));\n        }\n        if (this.$vm.$esRouteMode === 'hash') {\n            history.pushState({\n                path: path,\n                query: query,\n                params: params\n            }, null, \"#\" + path + this.utils.buildQuery(query));\n        }\n        this.$vm.$esRouteObject = {\n            path: path,\n            query: query,\n            params: params\n        };\n    };\n    Lifecycle.prototype.$onInit = function () {};\n    Lifecycle.prototype.$beforeMount = function () {};\n    Lifecycle.prototype.$afterMount = function () {};\n    Lifecycle.prototype.$onDestory = function () {};\n    Lifecycle.prototype.$hasRender = function () {};\n    Lifecycle.prototype.$watchState = function (oldData, newData) {};\n    return Lifecycle;\n}();\nexports.default = Lifecycle;\n\n//# sourceURL=webpack:///./src/Lifecycle/index.ts?");
