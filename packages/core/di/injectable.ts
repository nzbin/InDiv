...
export function Injectable(options?: TInjectableOptions): (_constructor: Function) => void {
  return function (_constructor: Function): void {
      ...
      if (options && options.providedIn) {
        ...
        // else {
        //   if (!(options.providedIn as Type<INvModule>).prototype.$providers) (options.providedIn as Type<INvModule>).prototype.$providers = [];
        //   ((options.providedIn as Type<INvModule>).prototype.$providers as Function[]).push(_constructor);
        // }
      }
  };
}
